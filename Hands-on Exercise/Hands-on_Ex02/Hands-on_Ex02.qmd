...
#### Method 1: Plot choropleth quickly using qtm()
...
#### Method 2: Create choropleth map using tmap elements
...
#### Method 3: By defining a group-by variable in tm_facets()
...
### Plotting a choropleth map based on a selected region
