...
## 2.1 Thematic Mapping and Geovisualisation
...
## 2.4 Joining attribute data with geospatial data
...
## 2.5 Choropleth Mapping Geospatial Data

### 2.5.1 Method 1: Plot choropleth quickly using qtm()
...
### 2.5.2 Method 2: Create choropleth map using tmap elements
...
### 2.6.1 Drawing a choropleth map
...
## 2.7 Data Classification Methods of tmap
...
### 2.7.1 Additional data classification methods
...
### 2.7.2 Plotting choropleth map with custom breaks
...
## 2.10 Small Multiple Choropleth Maps (Facet Maps)

### 2.10.1 Method 1: Assign multiple values to at least one of the aesthetic arguments
...
### 2.10.2 Method 2: Arrange multiples choropleth maps in a grid layout
...
### 2.10.3 Method 3: By defining a group-by variable in tm_facets()
...
## 2.11 Plotting a choropleth map based on a selected region
...
### 2.11.1 Complementing Thematic Map with Statistical Chart
