...
### 1.7 Creating a simple feature data frame from an aspatial data frame
...
### 1.8 Geoprocessing with sf packages

sf package can perform geoprocessing functions (i.e. GIS analysis).

#### 1.8.1 Use case 1: Land acquisition analysis
...
#### 1.8.2 Use case 2: Determine the number of pre-schools by planning subzone
